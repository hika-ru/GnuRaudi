...
class if_else(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._f_c_line_edit.returnPressed.connect(
        	lambda: self.set_f_c(eng_notation.str_to_num(str(self._f_c_line_edit.text().toAscii()))))
        self.top_grid_layout.addWidget(self._f_c_tool_bar)
